...
class GattClient extends EventEmitter {
    ...
    return this._queueOperation(() => {
      ...
      return connection.connect().then(() => {
        return new Promise((resolve, reject) => {
          let watcher = GattUtils.addWatcher(this.peripheral, reject);
          this.peripheral.discoverSomeServicesAndCharacteristics(
            ...
            (err, services, characteristics) => {
              ...
              GattUtils.removeWatcher(this.peripheral, watcher);
              ...
              watcher = GattUtils.addWatcher(this.peripheral, reject);
  ...
  pairSetup(pin) {
    return this._queueOperation(() => {
      ...
      return connection.connect().then(() => {
        return new Promise((resolve, reject) => {
          const watcher = GattUtils.addWatcher(this.peripheral, reject);
          this.peripheral.discoverSomeServicesAndCharacteristics(
            [serviceUuid],
            [characteristicUuid],
            (err, services, characteristics) => {
              ...
              for (const service of services) {
                ...
                promises.push(
                  new Promise((resolve, reject) => {
                    const watcher =
                      GattUtils.addWatcher(this.peripheral, reject);
