...
class PairingProtocol {
  ...
  buildPairSetupM1() {
    const packet = TLV.encodeObject({
      [TLV.Types.kTLVType_State]: Buffer.from([TLV.Steps.M1]),
      [TLV.Types.kTLVType_Method]: Buffer.from([TLV.Methods.PairSetup]),
    });
  ...
  parsePairSetupM2(m2Buffer) {
    return new Promise((resolve, reject) => {
      ...
      if (tlv[TLV.Types.kTLVType_State][0] !== TLV.Steps.M2) {
        reject('Invalid state');
        return;
      }

      if (tlv[TLV.Types.kTLVType_Error]) {
        reject(`Error: ${tlv[TLV.Types.kTLVType_Error]}`);
        return;
      }
  ...
  buildPairSetupM3(m2Tlv, pin) {
    return new Promise((resolve) => {
      srp.genKey(32, (err, key) => {
        this.srpClient = new srp.Client(srp.params['3072'],
                                        m2Tlv[TLV.Types.kTLVType_Salt],
                                        Buffer.from('Pair-Setup'),
                                        Buffer.from(pin),
                                        key);
        this.srpClient.setB(m2Tlv[TLV.Types.kTLVType_PublicKey]);

        const packet = TLV.encodeObject({
          [TLV.Types.kTLVType_State]: Buffer.from([TLV.Steps.M3]),
          [TLV.Types.kTLVType_PublicKey]: this.srpClient.computeA(),
          [TLV.Types.kTLVType_Proof]: this.srpClient.computeM1(),
        });
  ...
  parsePairSetupM4(m4Buffer) {
    return new Promise((resolve, reject) => {
      ...
      if (tlv[TLV.Types.kTLVType_State][0] !== TLV.Steps.M4) {
        reject('Invalid state');
        return;
      }
      ...
      if (!tlv[TLV.Types.kTLVType_Proof]) {
        reject('Proof missing from TLV');
        return;
      }

      try {
        this.srpClient.checkM2(tlv[TLV.Types.kTLVType_Proof]);
      } catch (e) {
        reject('Proof verification failed');
        return;
      }
  ...
  buildPairSetupM5() {
    return new Promise((resolve) => {
      ...
      new HKDF(
        ...
        const iOSDeviceSignature = Buffer.from(sodium.crypto_sign_detached(
          iOSDeviceInfo,
          this.iOSDeviceLTSK
        ));

        const subTlv = TLV.encodeObject({
          [TLV.Types.kTLVType_Identifier]: this.iOSDevicePairingID,
          [TLV.Types.kTLVType_PublicKey]: this.iOSDeviceLTPK,
          [TLV.Types.kTLVType_Signature]: iOSDeviceSignature,
        });
        ...
        new HKDF(
          ...
          const tlv = TLV.encodeObject({
            [TLV.Types.kTLVType_State]: Buffer.from([TLV.Steps.M5]),
            [TLV.Types.kTLVType_EncryptedData]: encryptedData,
          });
  ...
  parsePairSetupM6(m6Buffer) {
    return new Promise((resolve, reject) => {
      ...
      if (tlv[TLV.Types.kTLVType_State][0] !== TLV.Steps.M6) {
        reject('Invalid state');
        return;
      }
      ...
      if (!tlv[TLV.Types.kTLVType_EncryptedData]) {
        reject('Encrypted data missing from TLV');
        return;
      }
      ...
      try {
        decryptedData = Buffer.from(
          sodium.crypto_aead_chacha20poly1305_ietf_decrypt(
            null,
            tlv[TLV.Types.kTLVType_EncryptedData],
            null,
        ...
        reject('Decryption of sub-TLV failed');
        return;
      }

      const subTlv = TLV.decodeBuffer(decryptedData);

      if (!subTlv[TLV.Types.kTLVType_Signature]) {
        reject('Signature missing from sub-TLV');
        return;
      }

      if (!subTlv[TLV.Types.kTLVType_Identifier]) {
        reject('Identifier missing from sub-TLV');
        return;
      }

      if (!subTlv[TLV.Types.kTLVType_PublicKey]) {
        reject('Public key missing from sub-TLV');
        return;
      }
      ...
      new HKDF(
        ...
        this.AccessoryPairingID = subTlv[TLV.Types.kTLVType_Identifier];
        this.AccessoryLTPK = subTlv[TLV.Types.kTLVType_PublicKey];
        const AccessorySignature = subTlv[TLV.Types.kTLVType_Signature];
  ...
  buildPairVerifyM1() {
    ...
    const packet = TLV.encodeObject({
      [TLV.Types.kTLVType_State]: Buffer.from([TLV.Steps.M1]),
      [TLV.Types.kTLVType_PublicKey]: this.pairVerify.publicKey,
    });
  ...
  parsePairVerifyM2(m2Buffer) {
    return new Promise((resolve, reject) => {
      ...
      if (!tlv[TLV.Types.kTLVType_PublicKey]) {
        reject('Public key missing from TLV');
        return;
      }
      ...
      this.pairVerify.accessoryPublicKey = tlv[TLV.Types.kTLVType_PublicKey];

      this.pairVerify.sharedSecret = Buffer.from(sodium.crypto_scalarmult(
      ...
      new HKDF(
        ...
        const AccessoryPairingID =
          subTlv[TLV.Types.kTLVType_Identifier].toString();
        if (AccessoryPairingID !== this.AccessoryPairingID.toString()) {
          reject('Wrong accessory pairing ID');
          return;
        }
        ...
        const signature = subTlv[TLV.Types.kTLVType_Signature];
  ...
  buildPairVerifyM3() {
    ...
    const subTlv = TLV.encodeObject({
      [TLV.Types.kTLVType_Identifier]: Buffer.from(this.iOSDevicePairingID),
      [TLV.Types.kTLVType_Signature]: iOSDeviceSignature,
    });
  ...
  buildAddPairingM1(identifier, ltpk, isAdmin) {
    const packet = TLV.encodeObject({
      [TLV.Types.kTLVType_State]: Buffer.from([TLV.Steps.M1]),
      [TLV.Types.kTLVType_Method]: Buffer.from([TLV.Methods.AddPairing]),
      [TLV.Types.kTLVType_Identifier]: Buffer.from(identifier),
      [TLV.Types.kTLVType_PublicKey]: ltpk,
      [TLV.Types.kTLVType_Permissions]: Buffer.from([isAdmin ? 1 : 0]),
    });
    return Promise.resolve(packet);
  }
  ...
  buildRemovePairingM1(identifier) {
    const packet = TLV.encodeObject({
      [TLV.Types.kTLVType_State]: Buffer.from([TLV.Steps.M1]),
      [TLV.Types.kTLVType_Method]: Buffer.from([TLV.Methods.RemovePairing]),
      [TLV.Types.kTLVType_Identifier]: Buffer.from(identifier),
    });
    return Promise.resolve(packet);
  }
  ...
  buildListPairingsM1() {
    const packet = TLV.encodeObject({
      [TLV.Types.kTLVType_State]: Buffer.from([TLV.Steps.M1]),
      [TLV.Types.kTLVType_Method]: Buffer.from([TLV.Methods.ListPairings]),
    });
    return Promise.resolve(packet);
  }
